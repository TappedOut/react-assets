    ...
    return (
      <thead>
        <tr>
          ...
          <th onClick={this.handleHeaderClick} style={{"text-align": "center", "vertical-align": "middle", "width": "12%"}}>Has</th>
          <th onClick={this.handleHeaderClick} style={{"text-align": "center", "vertical-align": "middle", "width": "12%"}}>Wants</th>
