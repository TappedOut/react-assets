...
export default class CollectionTableApp extends React.Component {
  ...
  getCardComponent = (card, i) => {
    if (this.state.init_data.type === 'inventory' || this.state.init_data.type === 'mobile') {
        return (
          <InventoryCard
            data={card}
            init_data={this.state.init_data}
            onEdit={this.handleCardEdit}
            onQtyToggle={this.handleQtyToggleEdit}
            row_number={i}
      ...
      if (this.state.init_data.type === 'binder') {
        return (
          <BinderCard
            ...
            init_data={this.state.init_data}
            onEdit={this.handleCardEdit}
            onHasQtyToggle={this.handleQtyToggleEdit}
            onWantsQtyToggle={this.handleWantsQtyToggleEdit}
            row_number={i}
            show_qty_edit={i === this.state.row_qty_editing}
  ...
  render() {
    ...
    const cards = this.state.cards.map((card, i) => {
      return this.getCardComponent(card, i)
    })
    ...
    if (this.state.init_data.type === 'mobile' || window.django.is_mobile) {
      filters = (
        <Modal show={this.state.filter_open} onHide={this.toggleFilters}>
          ...
          <Modal.Footer>
            <Button variant="secondary" onClick={this.toggleFilters}>
              Close
            </Button>
          </Modal.Footer>
        </Modal>
